...
\title{Migration bamboo vers jenkins}

\author{Dhia Akermi \& Yassin Soltani}
%%% if necessary
...
\proFramerName{Monsieur Makrem Ouejheni}
\proFramerSpeciality{Devops manager}

%% Encadrant académique
\academicFramerName{Madame Hela Limam}
